...
#Species to mask when computing PhyloP
...
#Reference genome for PhyloP output
phylop_species="Orcinus_orca"
#Output folder name
folder_name="Orcinus_orca_PhyloP_MaskAquatic_New"

#Takes a while so can comment out if already done previously, copies scripts to scratch to prevent slowdown due to Home I/O

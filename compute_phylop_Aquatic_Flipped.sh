...
to_mask="Bos_taurus,Tragulus_javanicus,Moschus_moschiferus,Bubalus_bubalis,Bos_indicus,Bos_mutus,Bison_bison,Beatragus_hunteri,Ammotragus_lervia,Hemitragus_hylocrius,Capra_hircus,Capra_aegagrus,Ovis_aries,Ursus_maritimus,Ailuropoda_melanoleuca,Mustela_putorius,Loxodonta_africana"
